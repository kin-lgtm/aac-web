            ...
            <div>
              ...
              <div className="bg-green-50 p-6 rounded-xl mb-6 border-2 border-green-200">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-800 mb-1">Chat with us on WhatsApp</h3>
              ...
              <div className="bg-primary-50 p-6 rounded-xl border-2 border-primary-200">
                <h3 className="font-bold text-gray-800 mb-3">Registration Information</h3>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-800 mb-4">Other Ways to Connect</h2>
          </div>
