...
const TrainingWorkshops = () => {
  const service = {
    ...
    shortDesc: 'Professional training programs for farmers and agricultural entrepreneurs',
    features: [
      'Sustainable farming techniques',
      'Modern agricultural practices',
      'Floriculture and landscaping',
      'Quality standard certification prep',
      'Pest and disease management',
      'Post-harvest handling and value chain management',
      'Workplace safety and best practices',
      'Stress management/ Personality development to boost worker efficiency',
      'Waste management: Waste as a resource',
    ],
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl text-gray-800 mb-4" style={{fontFamily: 'Impact, "Arial Black", sans-serif', letterSpacing: '0.02em'}}>
              Empower Your Team with Modern Knowledge and Technology
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our tailor-made training programs, workshops and courses provide practical knowledge and develop skills to boost the productivity and profitability.
            </p>
          </div>
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {service.features.map((feature, index) => (
                <div key={index} className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 text-center">
                  ...
                  <p className="text-sm text-gray-600">Expert training and certification</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary-600 to-primary-800 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-primary-100">
            Contact us to schedule a workshop and empower your team with cutting-edge agricultural knowledge.
          </p>
