...
const ResearchDataServices = () => {
  const service = {
    ...
    features: [
      'Agricultural/ agribusiness project proposal formulation',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Leverage our research and analytics to make informed decisions and boost performance of your farm/ agribusiness.
            </p>
          </div>
          <div>
