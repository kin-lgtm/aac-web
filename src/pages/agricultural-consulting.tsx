const AgriculturalConsulting = () => {
  const service = {
    title: 'Agricultural Consulting',
    shortDesc: 'Comprehensive agribusiness consulting for sustainable growth',
    features: [
      'Sustainable food crop production',
      'Controlled environment (greenhouse) agriculture',
      'Landscaping & floriculture',
      'Postharvest handling and value chain management',
      'Livestock production',
      'Agribusiness management',
      'Quality standard certification guidance (eg. SL- GAP/ SLS- 1324/ Organic/ ISO 22000/ ISO 9000/ HACCP)',
      'Agro/ Eco-tourism',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our expert consultants combine traditional wisdom with modern strategies to help your farm and agribusiness thrive.
            </p>
          </div>
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {service.features.map((feature, index) => (
                <div key={index} className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 text-center">
                  ...
                  <p className="text-sm text-gray-600">Professional expertise and guidance</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary-600 to-primary-800 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-primary-100">
            Contact us for a free consultation and start transforming your agricultural business today.
          </p>
...
export default AgriculturalConsulting;